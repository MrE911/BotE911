...
/////////////////
const BotName = 'E_Bot☄'; 
const instagram = 'https://instagram.com/off.males_'; 
const telegram = 'https://t.me/EAjah'; 
const kapanbotaktif = 'KETIKA LO BUTUH GW'; 
const youtube = 'https://youtube.com/channel/UCVCACf1t6unD2sGH9dEcYpQ';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@Off.males_')
